...
@Component({
  selector:     'client_reg4',
  templateUrl:  './app/components/_client_reg/client_reg4/client_reg4.component.html',
  styleUrls:  [ './app/components/_client_reg/client_reg4/client_reg4.component.css' ],
  directives: [z__model_registation_steps],
  providers:  [CriptoService]
})

export class client_reg4 implements OnInit { 
