...
@Component({
  selector:     'client_reg_15min',
  templateUrl:  './app/components/_client_reg/client_reg_15min/client_reg_15min.component.html',
  styleUrls:  [ './app/components/_client_reg/client_reg_15min/client_reg_15min.component.css' ],
  directives: [z__model_registation_steps],
  providers:  [CriptoService]
})

export class client_reg_15min implements OnInit { 
    ...
    ngOnInit() {
        console.log('The client_reg_15min');
