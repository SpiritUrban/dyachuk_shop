...
@Component({
  selector:     'model_reg1',
  templateUrl:  './app/components/_model_reg/model_reg1/model_reg1.component.html',
  styleUrls:  [ './app/components/_model_reg/model_reg1/model_reg1.component.css' ],
  directives: [z__model_registation_steps],
  providers:  [CriptoService]
})

export class model_reg1 implements OnInit { 
    ...
    request() {       
        ...
        this.body = JSON.stringify({ 
            ...
            account:    'Model' // Задати тип акаунту
        }); 
