...
@Component({
  selector:     'payment',
  templateUrl:  './app/components/payment/payment/payment.component.html',
  styleUrls:  [ './app/components/payment/payment/payment.component.css' ],
...
export class payment implements OnInit { 
    ...
    ngOnInit() {
        ...
        //jQuery('.input').css('color','red !important');
